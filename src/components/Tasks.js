...
class Tasks extends Component {
  ...
  async componentDidMount() {
    ...
    db.collection("myScore")
      .where("name", "==", localStorage.getItem("s_user"))
      .get()
      .then((querySnapshot) => {
  ...
  handleIncrement = () => {
    if (this.state.count < 9) {
      ...
      const db = firebase.firestore();
      db.collection("myScore").add({
        name: localStorage.getItem("s_user"),
        ...
        <table width="100%" border="0" cellPadding="10">
          <tr>
            ...
            <td width="50%" align="right">
              <Link to="/components/logout">
                <button onClick={this.logout} class="btn btn-outline-info">
                  Logout
                </button>
              </Link>
            </td>
                ...
                <td>
                  ...
                  >
                    <thead>
                      <tr>
                        <td class="card-header">
                          <h6>Player : {localStorage.getItem("s_user")}</h6>
                        </td>
                      </tr>
                    </thead>
                    <tr>
                      <td>
                        <button class="btn btn-warning pull-left btn-block btn-lg">
                          <table>
                            <tr>
                              <td>
                                <h6>
                    ...
                    <tr>
                      <td>
                        <button
                          class="btn btn-outline-info pull-left btn-block"
                          onClick={this.handle_1}
                        >
                          <table>
                            <tr>
                              <td>
                                <input
                                  type="radio"
                                  name="rad"
                                  onChange={this.handleCheck_1}
                                  checked={this.state.chck_1}
                                />
                              </td>
                              <td>
                                &nbsp;{" "}
                          ...
                          <table>
                            <tr>
                              <input
                                type="radio"
                                name="rad"
                                onChange={this.handleCheck_2}
                                checked={this.state.chck_2}
                              />
                              <td></td> &nbsp;{" "}
                            ...
                            <tr>
                              <td>
                                <input
                                  type="radio"
                                  name="rad"
                                  onChange={this.handleCheck_3}
                                  checked={this.state.chck_3}
                                />
                              </td>
                              <td>
                                {" "}
                          ...
                          <tr>
                            <td width="50%">
                              ...
                              <button
                                ...
                                class="btn btn-info btn-block my-6"
                                disabled={this.state.btnNext}
                              >
                                Next
                              </button>
                            </td>
